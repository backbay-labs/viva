...
async fn two_turn_live_orchestration_trace_is_stable_across_extraction() {
    ...
    assert_eq!(
        ...
        vec![
            "session_phase:Ready",
            "question_started:response-1:q-oxidative-phosphorylation-nadh:oxidative-phosphorylation:criteria=2",
            "input_speech_started",
            "session_phase:Listening",
            "transcript_final:response-1:confidence=none",
            "input_speech_stopped",
            ...
            "concept_status:response-1:oxidative-phosphorylation=Strong",
            "usage:text_in=20:text_out=10:corrections=1",
            "audio_delta:response-1:bytes=4",
            "session_phase:Feedback",
            "session_phase:Correction",
            "response_completed:response-1",
            "question_started:response-2:q-oxidative-phosphorylation-atp:oxidative-phosphorylation:criteria=2",
            "input_speech_started",
            "session_phase:Listening",
            "transcript_final:response-2:confidence=none",
            "input_speech_stopped",
            ...
            "concept_status:response-2:oxidative-phosphorylation=Strong",
            "usage:text_in=20:text_out=10:corrections=1",
